//------------------------------------------------------------------------------
// <copyright file="FastClassesCppPackage.cs" company="Company">
...
namespace FastClassesVSIX
{
    ...
    {
        /// <summary>
        /// FastClassesCppPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "edf0b911-3184-4392-a319-dcd4117f808c";

        /// <summary>
        /// Initializes a new instance of the <see cref="FastClassesCpp"/> class.
        /// </summary>
        public FastClassesCppPackage()
        {
